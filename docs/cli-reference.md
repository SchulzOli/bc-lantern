...
```text
bccli app-json retrieve [-h] [--owner OWNER] [--include-archived]
                               [--output OUTPUT] [--cache-dir CACHE_DIR] [--refresh]
                               [--no-cache]
```
...
```text
bccli object-ranges report [-h] [--app-json APP_JSON] --reference REFERENCE
...
```text
bccli docs sync [-h] [--output OUTPUT] [--check]
```
