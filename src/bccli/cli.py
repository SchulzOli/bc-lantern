...
from bccli.github import GhClient
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="bccli", description="Business Central / AL command-line helpers"
    )
    ...
    *,
    ...
    try:
        ...
        if args.command == "docs" and args.docs_command == "sync":
            ...
            return 0
    except (InvalidAppJsonError, ObjectRangeDataError) as error:
